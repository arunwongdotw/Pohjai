appControllers.controller('seeAllListCtrl', function($scope, $timeout, $state, $stateParams, $ionicHistory, $ionicPlatform, $http, myService, $mdDialog) {
  $scope.appLanguage = {};
  ...
  if (Object.keys(myService.allName).length === 0) {
    $scope.all = myService.allAns;
    $scope.flag = 1;
  } else if (Object.keys(myService.allAns).length === 0) {
    $scope.all = myService.allName;
    $scope.flag = 2;
  }
  ...
  $scope.btnBack = function() {
    $scope.navigateTo('menu2.basicchart');
  };
});
